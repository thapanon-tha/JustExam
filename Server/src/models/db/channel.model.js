module.exports = (sequelize, Sequelize) => {
  const channel = sequelize.define(
    'channel',
    {
      ...
      inviteCode: { type: Sequelize.STRING(100), allowNull: false, field: 'inviteCode' },
      ...
      schedule: { type: Sequelize.DATE(6), allowNull: false, field: 'schedule' },
      startAt: { type: Sequelize.DATE(6), allowNull: false, field: 'startAt' },
      endAt: { type: Sequelize.DATE(6), allowNull: false, field: 'endAt' },
      releaseScoreFlag: {
