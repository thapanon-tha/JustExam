...
const channels = (query = {}) => axios.get(`${BACKEND_HOST}/api/channels`, {
  params: query,
...
const isTA = (cid) => axios.get(`${process.env.VUE_APP_API}/api/channels/${cid}/isTA`, {
  validateStatus: false,
});
const createChannel = (data) => axios.post(
  `${BACKEND_HOST}/api/channels/`,
  { data },
  { validateStatus: false },
);

const leaveChannel = (cid) => axios.delete(`${BACKEND_HOST}/api/channels/${cid}/leave`, {
  validateStatus: false,
});

const deleteChannel = (cid) => axios.delete(`${BACKEND_HOST}/api/channels/${cid}`, {
  validateStatus: false,
});

const channelUpdate = (cid, data) => axios.put(
  `${BACKEND_HOST}/api/channels/${cid}`,
  { data },
  { validateStatus: false },
);

const joinChannel = (cid, data) => axios.post(
  `${BACKEND_HOST}/api/channels/${cid}/members`,
  { data },
  { validateStatus: false },
);

const connectExamtoChennal = (data) => axios.post(
  `${BACKEND_HOST}/api/channels/${data.cid}/exams`,
  { data },
  { validateStatus: false },
);
...
const disconnectExamtoChennal = (cid, ecid) => axios.delete(`${BACKEND_HOST}/api/channels/${cid}/exams/${ecid}`, {
  validateStatus: false,
});
...
const memberJoin = (cid, data) => axios.post(
  `${BACKEND_HOST}/api/channels/${cid}/members`,
  { data },
  { validateStatus: false },
);
...
const updateStudentScore = (cid, data) => axios.put(
  `${BACKEND_HOST}/api/channels/${cid}/answer`,
  { data },
  { validateStatus: false },
);
