<template>
  <div class="ml-10 mt-10 mr-10 mb-10">
    ...
    <textarea
      class="ml-5 w-5/6 h-40 px-3 py-3 font-semilight text-gray-700 bg-gray-200 bg-clip-padding border-2 border-solid border-gray-300 border-opacity-70 rounded-md"
