  ...
  <div class="flex flex-col justify-center">
    <div class="flex flex-row mt-5 justify-start ml-5">
      <div
        ...
        rounded-xl shadow-sm font-semilight
        text-mainColor mr-2"
      ...
      <ActionButton
        class="w-12 h-12 bg-mainColor border border-solid rounded-full
        shadow-sm font-semilight text-white mt-1 ml-2"
        name="+"
        @on-click="addSection"
      />
    </div>
    ...
    >
      <div class="flex flex-col justify-center">
          ...
          >
            ...
            <div class="flex flex-col ml-10">
              ...
              <button
                ...
                rounded-lg font-semilight text-mainColor p-1"
              ...
              border-orange-200 border border-solid
                rounded-lg font-semilight text-mainColor"
        ...
        <ActionButton
          ...
          rounded-lg px-3 py-2 font-semilight text-mainColor
          shadow-md hover:text-white hover:bg-mainColor"
          name="+ Add a question"
