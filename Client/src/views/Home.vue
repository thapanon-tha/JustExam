...
<script>
import CardWithPicture from '@/components/Card/CardWithPicture.vue';
      ...
      topics: [
        {
          id: 'justexam',
          title: 'Just Exam',
          image: 'https://images.pexels.com/photos/4050320/pexels-photo-4050320.jpeg?auto=compress&cs=tinysrgb&dpr=2&h=650&w=940',
          description: 'A Web Application For An Online Exam.',
          imageLeft: false,
          fullText:
            `Just Exam is a web application for an online exam that helps a teacher \n
